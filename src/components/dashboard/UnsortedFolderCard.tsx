    ...
    >
      ...
      >
        <path
          ...
          className={`transition-colors ${
            isSelected
              ? 'fill-[#FFF3D5] dark:fill-[#3C533D] stroke-[#4D694E] dark:stroke-[#FF8C61]'
              : 'fill-[#F3F4F6] dark:fill-[#4D694E] stroke-[#E5E7EB] dark:stroke-[#3C533D]'
          }`}
          strokeWidth="2"
      ...
      <div className="absolute top-[20px] left-[24px] right-[24px] h-[75px] flex items-end justify-center pointer-events-none z-10">
        ...
        <div className="w-[90px] h-[70px] bg-white dark:bg-[#27272A] rounded-t-2xl border border-[#E5E7EB] dark:border-[#3F3F46] transform translate-y-0 transition-transform duration-200 group-hover:-translate-y-3 z-10 p-2.5 flex flex-col gap-1.5 shadow-none">
          <div className="flex items-center justify-between">
            <div className="w-8 h-1.5 bg-[#4D694E] rounded-full" />
            <ImageIcon className="w-3 h-3 text-[#4D694E]" />
          </div>
      ...
      >
        <path
          ...
          className={`transition-colors ${
            isSelected
              ? 'fill-[#FFFFFF] dark:fill-[#9E2B00] stroke-[#4D694E] dark:stroke-[#FF8C61]'
              : 'fill-[#FFFFFF] dark:fill-[#C53700] stroke-[#E5E7EB] dark:stroke-[#3C533D]'
          }`}
          strokeWidth="2"
          strokeLinejoin="round"
        />
      ...
      <div className="absolute left-[12px] right-[12px] bottom-[8px] top-[66px] z-30 flex flex-col justify-between p-3 select-none">
        ...
        <div className="flex items-end justify-between pt-1">
          ...
          <button
            ...
            className="flex items-center gap-1 px-3 py-1.5 rounded-xl bg-[#4D694E] hover:bg-[#3C533D] dark:bg-white dark:hover:bg-slate-100 text-white dark:text-[#4D694E] font-heading font-bold text-2xs tracking-wide transition-all active:scale-95 cursor-pointer shadow-none"
          >
