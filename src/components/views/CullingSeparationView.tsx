          ...
          <button
            ...
            className={`px-3 py-1 rounded-lg font-heading text-2xs font-bold transition-all cursor-pointer ${
              cullMode === 'KEEP_ALL_GOOD'
                ? 'bg-[#4D694E] text-white shadow-none'
      ...
      <div className="flex items-center justify-between bg-[#F9FAFB] dark:bg-[#0E0E0E] border border-[#E5E7EB] dark:border-[#27272A] rounded-2xl p-2 transition-colors">
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-xl font-heading text-xs font-bold transition-colors cursor-pointer ${
              activeTab === 'kept'
                ? 'bg-white dark:bg-[#1E1E1E] text-[#4D694E] border border-[#E5E7EB] dark:border-[#3F3F46] shadow-none'
                : 'text-[#4B5563] dark:text-[#A1A1AA] hover:text-[#111827] dark:hover:text-white'
            }`}
          >
          ...
          >
            {isAllSelected ? (
              <CheckSquare className="w-3.5 h-3.5 text-[#4D694E]" />
            ) : (
          ...
          {selectedIds.size > 0 && (
            <>
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#4D694E] hover:bg-[#3C533D] text-white font-heading text-xs font-bold transition-all cursor-pointer shadow-none active:scale-95"
              >
        ...
        <div className="bg-white dark:bg-[#0E0E0E] border border-[#E5E7EB] dark:border-[#27272A] rounded-2xl p-12 text-center flex flex-col items-center justify-center gap-3">
          ...
          {onGoToIngest && (
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#4D694E] hover:bg-[#3C533D] text-white font-heading text-xs font-bold tracking-wide transition-all mt-2 cursor-pointer shadow-none active:scale-98"
            >
                ...
                <div className="relative aspect-[4/3] w-full bg-slate-100 dark:bg-[#000000] overflow-hidden">
                  ...
                  <div className="absolute top-2.5 left-2.5 right-2.5 flex items-center justify-between pointer-events-none">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg bg-black/80 hover:bg-[#4D694E] text-white transition-colors cursor-pointer pointer-events-auto"
                    ...
                    <div className="flex items-center gap-1.5 pointer-events-auto">
                      ...
                      {isArchived ? (
                        ...
                        <span className="px-2 py-0.5 rounded-md text-2xs font-heading font-extrabold uppercase tracking-wider bg-[#4D694E] text-white">
                          Kept
                        </span>
                      )}
                    </div>
                    ...
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 px-3 rounded-xl font-heading text-xs font-bold tracking-wide transition-colors cursor-pointer ${
                        isArchived
                          ...
                          : 'bg-[#4D694E] hover:bg-[#3C533D] text-white'
                      }`}
                    >
                      {isArchived ? (
                        <>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between border-b border-[#E5E7EB] dark:border-[#27272A] pb-3">
              <div className="flex items-center gap-2">
                <Info className="w-5 h-5 text-[#4D694E]" />
              ...
              <button
                onClick={() => setInspectingItem(null)}
                className="p-1 rounded-lg text-[#9CA3AF] hover:text-[#4D694E] hover:bg-[#4D694E]/10 transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 overflow-y-auto">
              ...
              <div className="flex flex-col gap-2.5 text-xs font-sans">
                <div className="flex items-center justify-between p-2 rounded-xl bg-[#F9FAFB] dark:bg-[#181818] border border-[#E5E7EB] dark:border-[#27272A]">
                  ...
                  <span className="font-mono text-base font-extrabold text-[#4D694E]">
                ...
                <div className="grid grid-cols-2 gap-2 text-2xs">
                  ...
                  <div className="p-2 rounded-xl bg-slate-50 dark:bg-[#141414] border border-[#E5E7EB] dark:border-[#27272A]">
                    ...
                    <div className="font-mono text-xs font-bold text-[#4D694E] mt-0.5">
            ...
            <div className="flex items-center justify-between gap-2 pt-2 border-t border-[#E5E7EB] dark:border-[#27272A]">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#4D694E]/10 hover:bg-[#4D694E]/20 text-[#4D694E] dark:text-[#FF8C61] border border-[#4D694E]/30 font-heading text-xs font-bold transition-all cursor-pointer"
              >
                {geminiSingleLoading ? (
                  <>
                    <Loader2 className="w-3.5 h-3.5 animate-spin text-[#4D694E]" />
                    <span>Analyzing with Gemini Vision...</span>
                  </>
                ) : (
                  <>
                    <Zap className="w-3.5 h-3.5 text-[#4D694E]" />
