    ...
    <div className="flex flex-col gap-4 max-w-5xl overflow-y-auto pr-2 pb-6 select-none">
      ...
      {filteredClusters.length === 0 ? (
        <div className="bg-white dark:bg-[#20003A] border border-[#E7E0EE] dark:border-[#4C177D] rounded-2xl p-12 text-center flex flex-col items-center justify-center text-[#BCACCE]">
          ...
          <h3 className="font-heading text-xs font-bold text-[#23003F] dark:text-[#FFFDB4]">No Face Clusters Discovered Yet</h3>
          <p className="font-sans text-xs max-w-sm mt-1 text-[#5A476E] dark:text-[#BCACCE]">
            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-square w-full rounded-xl overflow-hidden bg-[#FAF8FD] dark:bg-[#2A0548] border border-[#E7E0EE] dark:border-[#4C177D] flex items-center justify-center">
                  <div className="w-14 h-14 rounded-full bg-gradient-to-tr from-[#F94500] to-[#23003F] text-[#FFFDB4] flex items-center justify-center font-heading font-extrabold text-lg shadow-sm">
                  ...
                  {isEditing ? (
                    <div className="flex items-center gap-1.5 flex-1 mr-2">
                      <input
                        ...
                        autoFocus
                        className="w-full bg-[#FAF8FD] dark:bg-[#2E074E] border border-[#F94500] rounded-lg px-2 py-1 font-sans text-xs text-[#23003F] dark:text-white outline-none"
                      />
                      <button
                    ...
                    <div className="flex flex-col">
                      <span className="font-heading font-bold text-xs text-[#23003F] dark:text-[#FFFDB4] truncate max-w-[170px]">
                        {displayName}
                      </span>
                      <span className="text-2xs text-[#BCACCE] font-mono tabular-nums">
                        Target: /{displayName}/
                      </span>
                    </div>
                  )}
                ...
                <div className="pt-2 border-t border-[#E7E0EE] dark:border-[#4C177D] flex items-center justify-between text-2xs text-[#BCACCE] font-mono tabular-nums">
                  <span>{cluster.associatedImageIds.length} Matches</span>
                  <span className="text-[#F94500] font-heading font-bold flex items-center gap-0.5">
