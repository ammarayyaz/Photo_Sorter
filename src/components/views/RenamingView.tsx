  ...
  return (
    <div className="flex flex-col gap-4 h-full overflow-y-auto pr-1 pb-6 select-none">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="font-sans text-xs text-[#4B5563] dark:text-[#A1A1AA] mt-0.5">
              Renames images starting with <span className="text-[#4D694E] font-bold">DSC_01</span> and varies the prefix letter for each folder (<span className="text-[#4D694E] font-bold">DSG</span>, <span className="text-[#4D694E] font-bold">DSH</span>...).
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <div className="flex items-center gap-1.5 bg-white dark:bg-[#181818] px-3 py-1.5 rounded-xl border border-[#E5E7EB] dark:border-[#27272A] text-xs">
            ...
            <select
              ...
              className="bg-transparent font-mono text-xs font-bold text-[#4D694E] outline-none cursor-pointer"
            >
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 truncate">
                  <FolderOpen className="w-4 h-4 text-[#4D694E] flex-shrink-0" />
              ...
              <div className="flex items-center justify-between gap-2 pt-1 border-t border-[#E5E7EB] dark:border-[#27272A]">
                ...
                <div className="flex items-center gap-1.5">
                  <input
                    ...
                    className="bg-[#F9FAFB] dark:bg-[#181818] border border-[#4D694E]/40 rounded-lg px-2 py-0.5 font-mono text-xs font-bold text-[#4D694E] text-center w-16 outline-none focus:border-[#4D694E]"
                  />
                  <button
      ...
      {items.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-0 border-t border-l border-[#E5E7EB] dark:border-[#27272A] rounded-2xl overflow-hidden">
                ...
                <div className="p-3.5 flex flex-col gap-2 bg-white dark:bg-[#111111]">
                  ...
                  <div className="flex items-center justify-between pt-1 border-t border-[#E5E7EB] dark:border-[#222222]">
                    <div className="flex items-center gap-1.5 truncate">
                      <FileSignature className="w-3.5 h-3.5 text-[#4D694E] flex-shrink-0" />
                      <span className="font-mono text-xs font-extrabold text-[#4D694E] truncate">
                        {preview?.renamed}
                      </span>
                    </div>
                    <button
